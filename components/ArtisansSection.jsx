  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-14">
      ...
      <div className="relative rounded-xl2 overflow-hidden shadow-soft grid md:grid-cols-[1.3fr_1fr] bg-navy min-h-[320px]">
        <div className="relative bg-gradient-to-br from-brown/40 to-navy/60 flex items-center justify-center">
          {/* Replace with a real photo of your artisans at work */}
          <span className="font-display text-cream/40">Artisan at work</span>
        </div>
